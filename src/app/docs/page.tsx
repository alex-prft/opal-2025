 ...
 *
 * Provides interactive API documentation using Swagger UI with the OpenAPI specification.
 * Includes authentication testing, request examples, and response validation.
 */
