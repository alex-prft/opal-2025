...
// Safe dynamic imports for client-side components
const AgentMonitoringDashboard = dynamic(() => import('@/components/AgentMonitoringDashboard'), {
  ssr: false,
  loading: () => (
    <div className="p-4 text-center">
      <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600 mx-auto mb-2"></div>
      <p className="text-sm text-gray-600">Loading agent monitoring...</p>
    </div>
  )
});

const RealTimeAgentStatus = dynamic(() => import('@/components/RealTimeAgentStatus'), {
  ssr: false,
  loading: () => (
 ...
 */
export default function OPALMonitoringPageClient() {
  // Client-side state
